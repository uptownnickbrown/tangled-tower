...
TangledTower.LEVELS = [
  ...
  // Level 2 - Golden Afternoon
  {
    ...
    spawns: [
      ...
      { type: 'vine_small',  freq: 400, startAfter: 100 },
      { type: 'vine_medium', freq: 700, startAfter: 1000 },
      { type: 'goblin',      freq: 600, startAfter: 300 },
      { type: 'bat',         freq: 1200, startAfter: 1800 },
  ...
  // Level 3 - Sunset
  {
    ...
    spawns: [
      ...
      { type: 'vine_small',  freq: 350, startAfter: 0 },
      { type: 'vine_medium', freq: 550, startAfter: 500 },
      { type: 'vine_tall',   freq: 900, startAfter: 2000 },
      { type: 'goblin',      freq: 500, startAfter: 200 },
      { type: 'bat',         freq: 700, startAfter: 500 },
  ...
  // Level 4 - Twilight
  {
    ...
    spawns: [
      ...
      { type: 'vine_small',  freq: 300, startAfter: 0 },
      { type: 'vine_medium', freq: 450, startAfter: 200 },
      { type: 'vine_tall',   freq: 700, startAfter: 800 },
      { type: 'goblin',      freq: 400, startAfter: 100 },
      { type: 'bat',         freq: 500, startAfter: 200 },
  ...
  // Level 5 - Moonlit Night
  {
    ...
    spawns: [
      ...
      { type: 'vine_medium', freq: 350, startAfter: 0 },
      { type: 'vine_tall',   freq: 550, startAfter: 300 },
      { type: 'goblin',      freq: 350, startAfter: 0 },
      { type: 'bat',         freq: 400, startAfter: 0 },
